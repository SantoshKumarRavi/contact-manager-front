  ...
  function deletebyicon(e) {
    ...
    (async function deleteData() {
        ...
        await fetch("https://contactmanagerbackend.onrender.com/contacts", {
          ...
          .then((x) => x.json())
          .then((removed) => {
            let updatedAfterDelete = [...file?.datas];
            ...
            setfile({ datas: updatedAfterDelete });
  ...
  return (
    <>
      {!searchedEmails?.datas?.length &&
        header?.heading &&
        file?.datas
          ?.slice(currentpage * defaultpage - defaultpage, currentpage * defaultpage)
          .map((x, i) => {
            return (
              <div className={(i%2!==0)?"data-wrapper hover-over-content common-inside-text-color alternate-color":"data-wrapper hover-over-content common-inside-text-color"} key={i}>
                ...
                >
                  <input
                    data-index={String(currentpage * defaultpage - defaultpage + i)}
                    ...
                    checked={deleteTracking[currentpage * defaultpage - defaultpage + i]?.checked}
                  />
                </div>
              ...
              style={{ color: "rgb(0,181,226)" }}
                ...
                /> */}
                    ...
                    <div className="delete-red-icon"  onClick={(e) => deletebyicon(e)}>
                      <VscTrash data-svgindex={currentpage * defaultpage - defaultpage + i} />
